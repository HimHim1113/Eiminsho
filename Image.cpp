...
Image::Image()
{
	...
	myLoadDivGraph("./dat/image/enemy/small.png", 2, 2, 1, 24, 24, _enemySmall);
	myLoadDivGraph("./dat/image/enemy/normal.png", 9, 3, 3, 40, 40, _enemyNormal);
	myLoadDivGraph("./dat/image/enemy/big.png", 9, 3, 3, 120, 90, _enemyBig);
}
